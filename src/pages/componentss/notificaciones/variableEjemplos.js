...
export const VARIABLE_EJEMPLOS = {
  ...
  NUMERO_DOCUMENTO_ESTUDIANTE: '52987654',
  NUMERO_IDENTIFICACION_ENTIDAD: '860.001.234-5',
  IDENTIFICACION_ESTUDIANTE: '52987654',
  TIPO_IDENTIFICACION: 'Cédula de ciudadanía',
  TIPO_DOCUMENTO_ESTUDIANTE: 'Cédula de ciudadanía',
  ...
  TIPO_OPORTUNIDAD: 'Práctica académica',
  MODALIDAD_VINCULACION: 'Acuerdo de vinculación',
  /** Obsoleto en catálogo; vista previa compatible con plantillas antiguas */
  TIPO_PRACTICA: 'Acuerdo de vinculación',
  FUNCIONES: 'Apoyo en análisis de datos y reportes.',
  FECHA: '20/02/2024',
  FECHA_INICIO: '15/01/2024',
  FECHA_FIN: '30/06/2024',
  CIUDAD: 'Bogotá D.C.',
  DIRECCION: 'Calle 12 # 3-45, Oficina 201',
